    ...
    <div className="min-h-screen pt-16 pb-16 md:pb-0">
      <div className="max-w-6xl mx-auto h-[calc(100vh-4rem)] flex">
        ...
        <div className={cn(
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredChats.length === 0 ? (
              <p className="text-sm text-ink/40 text-center py-8">No conversations yet</p>
            ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {chat.lastMessage && (
                        <p className={cn(
                          ...
                          chat.unreadCount > 0 ? 'text-ink/80 font-medium' : 'text-ink/50'
                        )}>
        ...
        {activeChat && otherUser ? (
          <div className={cn('flex flex-col flex-1 min-w-0', activeChat ? 'flex' : 'hidden md:flex')}>
            {/* Chat header */}
                    ...
                    <div key={msg.id} className={cn('flex gap-2', isMe && 'flex-row-reverse')}>
                      ...
                      <div className={cn(
                        ...
                        isMe
                          ...
                          : 'bg-warm border border-[var(--border)] text-ink rounded-tl-sm'
                      )}>
                        <p>{msg.content}</p>
          ...
          <div className="hidden md:flex flex-1 items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-ink/50">Select a conversation to get started</p>
            </div>
          </div>
        )}
      </div>
