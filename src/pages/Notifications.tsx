      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-20 lg:pt-24">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <button
              onClick={markAllRead}
              className="flex items-center gap-1.5 text-xs font-medium text-ink/60 hover:text-terracotta transition-colors"
            >
        ...
        {notifications.length === 0 ? (
          <div className="text-center py-24">
            ...
            <p className="text-sm text-ink/40">You'll see notifications for likes, comments, and follows here.</p>
          </div>
        ) : (
            ...
            {notifications.map(notif => (
              <div
                ...
                className={cn(
                  ...
                  notif.read
                    ? 'hover:bg-warm'
                    : 'bg-terracotta/5 hover:bg-terracotta/8 border border-terracotta/10'
                )}
              >
